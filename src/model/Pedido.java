...
public class Pedido {
	...
	public void imprimirPedido(){
		...
		System.out.println("Nome da cidade: " + this.cliente.cidade.nome);
		System.out.println("Total do pedido: " + this.totalPedido );
		if( this.produtos.size() == 0 ){
			System.out.println("Pedido Vazio");
		}else{
			System.out.println("Produtos do Pedido: R$" + String.format("%.2f", this.totalPedido) );
