		...
		do{
			...
			switch ( opcao ) {
				...
				case 2:
					...
					if(cidades.size()==0){
						JOptionPane.showMessageDialog(null, "É nescessário cadastrar as cidades primeiro!");
						cadastrarCidade();
						cidades = CidadeDAO.getCidades();
				...
				case 4:
					if(categorias.size()==0){
						JOptionPane.showMessageDialog(null, "É nescessário cadastrar as categorias primeiro!");
